...
const InstallationsDetailScreen = ({navigation}) => {
        ...
        <View flex={1}>
            <View bgColor={Colors.primary}>
                <SliderCustom
                    height={250}
                    items={[
                        {image: ImageRN.resolveAssetSource(require('../assets/aerobicsSlider.png')).uri},
            ...
            <View flex={1} mx={10}>
                <ScrollView flexGrow={1} pt={10}>
                    <Text color={Colors.primary} fontFamily={'titleBrandonBldBold'} fontSize={18}>CAMPO DE GOLF</Text>
...
export default InstallationsDetailScreen;